...
(function () {
	...
	MobileSelect.prototype = {
		...
		init: function (config) {
			...
			_this.wheel = getClass(_this.mobileSelect, 'c-mobile-select__wheel');
			_this.slider = getClass(_this.mobileSelect, 'c-mobile-select__container');
			_this.wheels = _this.mobileSelect.querySelector('.c-mobile-select__wheels');
		...
		renderWheels: function (wheelsData) {
			var _this = this;
			_this.mobileSelect = document.querySelector('.js-mobile-select');
			_this.mobileSelect.classList.add('c-mobile-select');
			_this.mobileSelect.innerHTML = '<div class="c-mobile-select__wheels"></div>';

			var tempHTML = '';
			for (var i = 0; i < wheelsData.length; i++) {
				//列
				tempHTML += '<div class="c-mobile-select__wheel"><ul class="c-mobile-select__container">';
				if (_this.jsonType) {
			...
			_this.mobileSelect.querySelector('.c-mobile-select__wheels').innerHTML = tempHTML;
		},
			...
			for (var i = 0; i < _this.displayJson.length; i++) {
				...
				(function (i) {
					...
					if (_this.wheel[i]) {
						...
						tempWheel.className = "c-mobile-select__wheels";
						tempHTML = '<ul class="c-mobile-select__container">';
						for (var j = 0; j < _this.displayJson[i].length; j++) {
							//行
							tempHTML += '<li data-id="' + _this.displayJson[i][j][_this.keyMap.id] + '">' + _this.displayJson[i][j][_this.keyMap.value] + '</li>';
						}
